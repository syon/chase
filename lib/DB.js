...
export default class CacheDB extends Dexie {
  ...
  async selectCachedPocketLatest100() {
    consola.info('[#selectCachedPocketLatest100] start')
    ...
    consola.info('[#selectCachedPocketLatest100] >>', arr)
    return arr
  }
  ...
  async prepareDigTable() {
    ...
    consola.info('[#prepareDigTable] promises.length', promises.length)
    return Promise.all(promises)
  }
